...
{
  public:
  DXCore(HINSTANCE hInstance, const char* titleBarText, unsigned int windowWidth, unsigned int windowHeight, bool debugTitleBarStats);
  ~DXCore();

  static DXCore* DXCoreInstance;
  static LRESULT CALLBACK WindowProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam);

  //"WindowProc" informs "ProcessMessage()" if something needs to be done.
